...
break;
  ...
  default:
      // Czech
        var tomorrow = "zítra u Vás";
        var nexttomorrow = "pozítří u Vás";
        var monday = "v pondělí u Vás";
        var tuesday = "v úterý u Vás";

        if (thehours >= 0 && thehours < 24 && dayOfWeek == 1) { // Mon
            deliveryMessage = nexttomorrow;
        } else if (thehours >= 0 && thehours < 24 && dayOfWeek == 2) { // Tue
            deliveryMessage = nexttomorrow;
        } else if (thehours >= 0 && thehours < 24 && dayOfWeek == 3) { // Wed
            deliveryMessage = nexttomorrow;
        } else if (thehours >= 0 && thehours < 24 && dayOfWeek == 4) { // Thu
            deliveryMessage = monday;
        } else if (thehours >= 0 && thehours < 24 && dayOfWeek == 5) { // Fri
